...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="isicontent">
      <form action="/laporan/generate/{{$report->id}}"method="POST" enctype="multipart/form-data"  onsubmit="return confirm('Pastikan Data Yang dilaporkan sudah benar')">
        @csrf 
            ...
            <div class="card-body">
                <form>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="date" class="form-control form-control-sm" name="tanggal" id="tanggal" value="{{$report->tanggal}}" readonly>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="NamaKaryawan" value="{{$report->NamaKaryawan}}" class="form-control" readonly>
                            <div class="text-danger">
                                @error('NamaKaryawan')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <input type="text" name="NamaJabatan" class="form-control" value="{{$report->NamaJabatan}}" readonly>
                            <div class="text-danger">
                                @error('NamaJabatan')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <input type="text" name="NamaJobdesk" class="form-control" value="{{$report->NamaJobdesk}}" readonly>
                            <div class="text-danger">
                                @error('NamaJobdesk')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input name="JobdeskDetail" class="form-control" value="{{$report->JobdeskDetail}}" readonly>
                                <div class="text-danger">
                                    @error('JobdeskDetail')
                                        {{ $message }}
                                    @enderror
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input name="KegiatanHarian" class="form-control" value="{{$report->KegiatanHarian}}" readonly>
                                <div class="text-danger">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="status" class="form-control custom-select">
                                <option selected disabled>Ajukan Laporan</option>
                                <option>Laporan Diterima</option>
                            </select>
                            <div class="text-danger">
                                @error('status') 
                                    {{ $message }}
